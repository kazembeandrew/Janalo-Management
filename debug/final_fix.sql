-- Final fix for journal entries without line_number column
...
BEGIN
    ...
    LOOP
        BEGIN
            ...
            -- Create debit line (Officer Advances) - without line_number
            ...
            -- Create credit line (Cash/Bank) - without line_number
            INSERT INTO public.journal_lines (
                journal_entry_id,
                account_id,
                debit,
