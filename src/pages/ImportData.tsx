...
import { FileSpreadsheet, Info, AlertTriangle, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-500">Migrate historical data or bulk record field collections using AI-assisted mapping.</p>
      </div>
          ...
          <div className="bg-indigo-900 rounded-2xl p-6 text-white shadow-lg">
            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                ...
                <p className="text-xs text-indigo-100 leading-relaxed">Upload any Excel or CSV file containing loan or repayment data.</p>
              </li>
              <li className="flex gap-3">
                <div className="h-5 w-5 rounded-full bg-indigo-800 flex items-center justify-center text-[10px] font-bold shrink-0">2</div>
                <p className="text-xs text-indigo-100 leading-relaxed">Our AI analyzes your headers and maps them to the system schema automatically.</p>
              </li>
              <li className="flex gap-3">
                <div className="h-5 w-5 rounded-full bg-indigo-800 flex items-center justify-center text-[10px] font-bold shrink-0">3</div>
                <p className="text-xs text-indigo-100 leading-relaxed">The system matches borrower names to existing records and validates amounts.</p>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-6">
            ...
            <ul className="space-y-2">
              <li className="text-[11px] text-amber-800 flex items-start">
                ...
                Borrower names must match exactly as registered in the system.
              </li>
              <li className="text-[11px] text-amber-800 flex items-start">
                <div className="h-1 w-1 rounded-full bg-amber-400 mt-1.5 mr-2 shrink-0" />
